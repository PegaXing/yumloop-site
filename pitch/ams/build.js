...
<style>
/* Static instances of the pitch page's Google Fonts, self-hosted: Chromium's PDF writer turns variable web fonts into
   Type3 outlines (unsearchable text); static TrueType subsets embed properly. Generated by fonts/instance.py. */
@font-face{font-family:Sora;font-weight:700;src:url(fonts/Sora-700.ttf)} @font-face{font-family:Sora;font-weight:800;src:url(fonts/Sora-800.ttf)} @font-face{font-family:Sora;font-weight:900;src:url(fonts/Sora-900.ttf)}
@font-face{font-family:Archivo;font-weight:500;src:url(fonts/Archivo-500.ttf)} @font-face{font-family:Archivo;font-weight:600;src:url(fonts/Archivo-600.ttf)}
@font-face{font-family:"JetBrains Mono";font-weight:500;src:url(fonts/JetBrainsMono-500.ttf)} @font-face{font-family:"JetBrains Mono";font-weight:700;src:url(fonts/JetBrainsMono-700.ttf)}
@font-face{font-family:"Nunito Sans";font-weight:400;src:url(fonts/NunitoSans-400.ttf)} @font-face{font-family:"Nunito Sans";font-weight:700;src:url(fonts/NunitoSans-700.ttf)}
</style>
